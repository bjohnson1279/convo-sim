      ...
      <div class="space-y-6">
        ...
        >
          ...
          >
            ...
            <div
              class="flex-1 my-4 flex flex-col-reverse gap-3 min-h-[160px] max-h-[240px] overflow-y-auto pr-1 text-xs scrollbar-thin focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded-lg"
              role="log"
              aria-live="polite"
              tabindex="0"
              aria-label={"Messages for conversation #{convo.id}"}
            >
              <%= if convo.status == :responding do %>
                <div
