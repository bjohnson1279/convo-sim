defmodule ConvoSimWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ConvoSimWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ConvoSimWeb.Gettext, "errors", msg, opts)
    end
  end
